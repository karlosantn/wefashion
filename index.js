...
function TecidoPlano() {
    ...
    PlanoT.style = "background-color: #FEAE11; padding-right: 10px; color: black;"
    MalhaT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    EstilismosT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    CroquiT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
...
function Estilismo() {
    ...
    Croqui.style = "display:none"
    PlanoT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    MalhaT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    EstilismosT.style = "background-color: #FEAE11; padding-right: 10px; color: black;"
    CroquiT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
...
function Croquis() {
    ...
    MalhaT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    EstilismosT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    CroquiT.style = "background-color: #FEAE11; padding-right: 10px; color: black;"
    AlunaPlano.style = "display: none;"
    AlunaMalha.style = "display: none;"
    AlunaEstilismo.style = "display: none;"
...
function Malhas() {
    ...
    Croqui.style = "display:none"
    PlanoT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    MalhaT.style = "background-color: #FEAE11; padding-right: 10px; color: black;"
    EstilismosT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    CroquiT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    AlunaPlano.style = "display: none;"
...
function TecidoPlanoB() {
    ...
    Estilismos.style = "display:none"
    Croqui.style = "display:none"
    PlanoBT.style = "background-color: #FEAE11; padding-right: 10px; color: black;"
    MalhaBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    EstilismosBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    CroquiBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
}
...
function EstilismoB() {
    ...
    Estilismos.style = "display:flex"
    Croqui.style = "display:none"
    PlanoBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    MalhaBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    EstilismosBT.style = "background-color: #FEAE11; padding-right: 10px; color: black;"
    CroquiBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
}
...
function CroquisB() {
    ...
    MalhaBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    EstilismosBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    CroquiBT.style = "background-color: #FEAE11; padding-right: 10px; color: black;"
}
...
function MalhasB() {
    ...
    Croqui.style = "display:none"
    PlanoBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    MalhaBT.style = "background-color: #FEAE11; padding-right: 10px; color: black;"
    EstilismosBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
    CroquiBT.style = "background-color: #152536; padding-rigth: 10px; color: white;"
}